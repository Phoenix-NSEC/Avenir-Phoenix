      ...
      <div className="flex justify-center items-center">
        <div className="flex p-3">
          <div className="flex justify-center flex-col">
            <p className="text-[30px] md:text-[60px] text-center   text-teal-500">{timerDays}</p>
        ...
        <div className="flex p-3 ">
          <div className="flex justify-center flex-col">
            <p className="text-[30px] md:text-[60px] text-center   text-teal-500">{timerHours}</p>
        ...
        <div className="flex p-3 ">
          <div className="flex justify-center flex-col">
            <p className="text-[30px] md:text-[60px]   text-center text-teal-500">{timerMinutes}</p>
        ...
        <div className="flex flex-col p-3">
          <div className="flex justify-center ">
            <p className="text-[30px] md:text-[60px]   text-teal-500">{timerSeconds}</p>
          </div>
