    ...
    return (
        <>
            ...
            <div className="card flex items-center md:mb-8 md:translate-x-[46px]">
                <div className='container overflow-y-scroll flex items-center main ease-in-out duration-300 relative md:w-[340px] w-[250px] md:h-[180px] h-[300px] md:hover:w-[400px] md:hover:h-[270px]'>
                    <div className="content md:static md:bottom-0 relative">
                        <div className="font-audiowide flex flex-col justify-center details md:absolute md:bottom-[19px] bottom-[-140px] z-20 ml-5 text-white md:text-2xl text-lg">
                            <p className='md:w-[250px] w-[150px]'>{props.title}</p>
                            ...
                            <div className="md:mt-6 mt-4 static flex flex-col hover:block btn-gr">
                                ...
                                <button className="cybr-btn btn2 mt-4 z-20" onClick={() => {
                                    setModalOpen(true);
